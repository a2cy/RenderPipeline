...
"")
        ...
        self.btn_reset_plugin_settings.setGeometry(QtCore.QRect(520, 20, 180, 31))
...
"}")
        ...
        self.lbl_hint_restart.setStyleSheet("border-top: 1px dotted #aaa; color: #ff9719; padding: 0;")
...
"a website or so."))
        ...
        self.lbl_hint_restart.setText(_translate("MainWindow", "Hint: Settings with a orange color require a pipeline restart when changed."))
